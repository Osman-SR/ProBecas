...
if(!$_SESSION){
	...
	$idd= $f3['id'];	
		...
		if ($beca=="BHMA") {
		$tipo_beca="BECA HIJO DE MILITAR ACTIVO";	
		$Nota = '';
		$Nota2 = '';
	}
...
//
    ...
    $pdf->SetFont('Arial','B',10);
    $pdf->Cell(50,-15,'                                                                                                                                       '.$tipo_beca.' ',0, 10 , ' L ');
    $pdf->Ln(6);
     $pdf->SetFont('Arial','',11);
    ...
    $pdf->SetFont('Arial','',11);
    $pdf->Cell(50,15,utf8_decode('                                                                                                     Para la Re-Inscripción al semestre:  '),0, 10 , ' L ');
    $pdf->SetFont('Arial','B',10);
    $pdf->Cell(50,-15,utf8_decode('                                                                                                                                                                              '.$semestre.'  '),0, 10 , ' L ');
    $pdf->SetFont('Arial','',11);
    $pdf->Cell(50,15,utf8_decode('                                                                                                                                                                   que '),0, 10 , ' L ');
    $pdf->Cell(50,-3,utf8_decode('comprende del periodo '),0, 10 , ' L ');
    $pdf->SetFont('Arial','B',10);
    $pdf->Cell(50,4,utf8_decode('                                         '.$periodo.' '.date("Y").', '),0, 10 , ' L ');
    $pdf->SetFont('Arial','',11);
    $pdf->Cell(50,-5,utf8_decode('                                                                              en virtud de cubrir con los requisitos señalados para esta beca.'),0, 10 , ' L ');
     $pdf->Ln(10);
     ...
     $pdf->Cell(50,-15,'',0,10,'C',$pdf->Image('../img/jalisco.png',7,270,195));
