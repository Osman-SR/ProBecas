...
if(!$_SESSION){
	...
	$Nota = '';
	$Nota2 = '';
	$tipo_beca="BECA FAMILIAR ADMINISTRATIVO";
	}
...
//
    ...
    $pdf->Ln(4);
    $pdf->SetFont('Arial','',11);
    $pdf->Cell(50,-15,'________________________________________________________________, colaborador de este Instituto,',0, 10 , ' L ');
    $pdf->Ln(6);
     $pdf->SetFont('Arial','',11);
    ...
    $pdf->SetFont('Arial','B',11);
    $pdf->Cell(50,-15,utf8_decode('                                                                                                                '.$periodo.' '.date("Y").','),0, 10 , ' L ');
    $pdf->SetFont('Arial','',11);
    $pdf->Cell(50,15,utf8_decode('                                                                                                                                                           en virtud de'),0, 10 , ' L ');

    $pdf->SetFont('Arial','',11);
    $pdf->Cell(50,-5,utf8_decode('cubrir con los requisitos señalados para esta beca.'),0, 10 , ' L ');
     $pdf->Ln(6);
