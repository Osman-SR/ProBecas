...
if(!$_SESSION){
 ...
 $query="Select * From becados Where Beca='BHMA' ";
...
function excel() {
window.location = "./Excel/bhma.php";
}
</script>
<script type="text/javascript">
function archivo() {
window.location = "./Descargar_Archivos/BHMA.php?id=Archivos_BHMA.zip";
}
</script>
...
if ($beca=="BHMA"){
    ...
    <select name="Beca"  class="becas"  onChange="window.document.location.href=this.options[this.selectedIndex].value;" value="GO">
		...
		<option value="bhma.php" selected>BECA HIJO DE MILITAR ACTIVO</option>
