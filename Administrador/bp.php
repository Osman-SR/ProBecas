...
if(!$_SESSION){
 ...
 $query="Select * From becados Where Beca='BPP' ";
...
function excel() {
window.location = "./Excel/bpp.php";
}
</script>
<script type="text/javascript">
function archivo() {
window.location = "Descargar_Archivos/bpp.php?id=Archivos.zip";
}
</script>
...
if ($beca=="BHMA"){
    ...
    <select name="Beca"  class="becas"  onChange="window.document.location.href=this.options[this.selectedIndex].value;" value="GO">
		...
		<option value="bp.php" selected>BECA POR PROMEDIO</option>
