...
if ($usuario==$usuario) {
	...
	mysql_query("update becados set nombre='$_POST[Nombre]', apellidop='$_POST[Apellidop]',apellidom='$_POST[Apellidom]',carrera='$_POST[Carrera]', semestre='$_POST[Semestre]', curp='$_POST[Curp]', sexo='$_POST[Sexo]', beca='$_POST[Beca]', folio='$folio', porcentaje='$por', status='$_POST[Status]'    
	...
	{
	mysql_query("update becados set nombre='$_POST[Nombre]', apellidop='$_POST[Apellidop]',apellidom='$_POST[Apellidom]', carrera='$_POST[Carrera]', semestre='$_POST[Semestre]', curp='$_POST[Curp]', sexo='$_POST[Sexo]', porcentaje='$_POST[Porcentaje]', status='$_POST[Status]'   
	where ncontrol='$_POST[usuario]'") or die(mysql_error());
	$directorio2='../Archivos/'.$beca.'/'.$_POST["Nombre"]. " ".$_POST["Apellidop"]." ".$usuario .'/';
	rename($directorio, $directorio2);
