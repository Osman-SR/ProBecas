...
if(!$_SESSION){
  ...
  $sql ="select * from becados where Sexo='Masculino' ";
  $result = mysql_query($sql);
  $resultado = mysql_num_rows($result);
  //echo 'Alumnos Hombres: '.$resultado.'';

  $sql1 ="select * from becados where Sexo='Femenino' ";
  $result1 = mysql_query($sql1);
  $resultado1 = mysql_num_rows($result1);
  //echo 'Alumnos Mujeres: '.$resultado1.'';
  ?>  
...
alert("ACTIVACION CANCELADA");
  ...
  <div class="tex"> 
  <section class="texto">
  <center><b><h2>GRAFICA POR TIPO DE SEXO</h2></b></center>
  <center>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Task', 'Hours per Day'],
          ['Masculino',  <?php echo $resultado ?>],
          ['Femenino',  <?php echo $resultado1 ?>]
        ]);

        var options = {
          title: 'GRAFICAS DE GENERO'
        };
