...
function excel() {
window.location = "./Excel/principal.php";
}
</script>
<script type="text/javascript">
function archivo() {
window.location = "descargar_archivos.php?id=Archivos.zip";
}
</script>
...
if ($beca=="BHMA"){
	...
	<h1>Alumnos Registrados</h1><center>
    ...
    <select name="Beca"  class="becas"  onChange="window.document.location.href=this.options[this.selectedIndex].value;" value="GO">
    	<option value="" selected>BECAS 
		<option value="bp.php">BECA POR PROMEDIO</option>
		<option value="bfa.php">BECA FAMILIAR ADMINISTRATIVO</option>
    ...
    <input type="button" class="dexcel" onClick="nuevo()" value="NUEVO USUARIO">
     </center>
    <br>
    <div id="datos">
