...
if(!$_SESSION){
 ...
 $query="Select * From becados Where Beca='BE' ";
...
function excel() {
window.location = "./Excel/be.php";
}
</script>

<script type="text/javascript">
function archivo() {
window.location = "Descargar_Archivos/be.php?id=Archivos.zip";
}
</script>
...
if ($beca=="BHMA"){
    ...
    <select name="Beca"  class="becas"  onChange="window.document.location.href=this.options[this.selectedIndex].value;" value="GO">
		...
		<option value="be.php" selected>BECA ESPECIAL</option>
