...
if(!$_SESSION){
 ...
 $query="Select * From becados Where Beca='BSS' ";
...
function excel() {
window.location = "./Excel/bss.php";
}
</script>
<script type="text/javascript">
function archivo() {
window.location = "Descargar_Archivos/bss.php?id=Archivos.zip";
}
</script>
...
if ($beca=="BHMA"){
    ...
    <select name="Beca"  class="becas"  onChange="window.document.location.href=this.options[this.selectedIndex].value;" value="GO">
		...
		<option value="bss.php" selected>BECA DE SERVICIO SOCIAL</option>
