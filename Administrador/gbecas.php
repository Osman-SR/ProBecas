...
if(!$_SESSION){
  header("location: ../index.html");
	...
	$sql ="select * from becados where Beca='BPP' ";
	$result = mysql_query($sql);
	$resultado = mysql_num_rows($result);
	//echo 'ISC: '.$resultado.'';

	$sql1 ="select * from becados where Beca='BFA' ";
	$result1 = mysql_query($sql1);
	$resultado1 = mysql_num_rows($result1);
	

		$sql2 ="select * from becados where Beca='BE' ";
	$result2 = mysql_query($sql2);
	$resultado2 = mysql_num_rows($result2);


	$sql3 ="select * from becados where Beca='BSS' ";
	$result3 = mysql_query($sql3);
	$resultado3 = mysql_num_rows($result3);

		$sql4 ="select * from becados where Beca='BHMA' ";
	$result4 = mysql_query($sql4);
	$resultado4 = mysql_num_rows($result4);

		$sql5 ="select * from becados where Beca='BFE' ";
...
alert("ACTIVACION CANCELADA");
  ...
  <center><b><h2>GRAFICA POR TIPO DE BECA</h2></b></center>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['BECAS', 'ALUMNOS'],
           ...
           ['BPP', <?php echo $resultado ?>],
           ['BFA', <?php echo $resultado1 ?>],
           ['BE', <?php echo $resultado2 ?>],
           ['BSS', <?php echo $resultado3 ?>],
           ['BHMA', <?php echo $resultado4 ?>],
           ['BFE', <?php echo $resultado5 ?>],
      
        ]);

        var options = {
          chart: {
            title: 'GRAFICAS DE BECAS',
